...
t_vec = UKF_block_x.time(1:14203);
...
% E
% figure(7)
% plot(t_vec, UKF_state(16,1:length(t_vec)),'b',...
%      t_vec, UKF_state(17,1:length(t_vec)),'c',...
%      t_vec, UKF_state(18,1:length(t_vec)),'m',...
%      t_vec, UKF_state(19,1:length(t_vec)),'y','LineWidth',2);
% hold on;
...
% figure(8)
% subplot(3,1,1)
% plot(t_vec, quadrotor.ex_enu(1,1:length(t_vec)),'b','LineWidth',2);
% title('Position Errors','FontSize',20);
% % x = xlabel('$t$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% y = ylabel('$e_{x_1}(rad)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% % legend('$error_x$', 'Interpreter', 'latex','FontSize',20)
% grid on
% subplot(3,1,2)
% plot(t_vec, quadrotor.ex_enu(2,1:length(t_vec)),'b','LineWidth',2);
% % title('2-D error_y Plot','FontSize',20);
% % x = xlabel('$t$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% y = ylabel('$e_{x_2}(rad)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% % legend('$error_y$', 'Interpreter', 'latex','FontSize',20)
% grid on
% subplot(3,1,3)
% plot(t_vec, quadrotor.ex_enu(3,1:length(t_vec)),'b','LineWidth',2);
% % title('2-D error_z Plot','FontSize',20);
% x = xlabel('$Time(sec)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% y = ylabel('$e_{x_3}(m)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
...
% y = ylabel('$e_{v_1}(m/s)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% grid on
% subplot(3,1,2)
% plot(t_vec, quadrotor.ev_enu(2,1:length(t_vec)),'b','LineWidth',2);
% y = ylabel('$e_{v_2}(m/s)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% grid on
% subplot(3,1,3)
% plot(t_vec, quadrotor.ev_enu(3,1:length(t_vec)),'b','LineWidth',2);
% x = xlabel('$Time(sec)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% y = ylabel('$e_{v_3}(m/s)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% grid on
...
% % x = xlabel('$t$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% y = ylabel('$e_{R_1}(rad)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
...
% y = ylabel('$e_{R_2}(rad)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
...
% x = xlabel('$Time(sec)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% y = ylabel('$e_{R_3}(rad)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
...
% y = ylabel('$e_{\Omega_1}(rad/s)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% grid on
% subplot(3,1,2)
% plot(t_vec, quadrotor.eW(2,1:length(t_vec)),'b','LineWidth',2);
% y = ylabel('$e_{\Omega_2}(rad/s)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% grid on
% subplot(3,1,3)
% plot(t_vec, quadrotor.eW(3,1:length(t_vec)),'b','LineWidth',2);
% x = xlabel('$Time(sec)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% y = ylabel('$e_{\Omega_3}(rad/s)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% grid on

% Thrust
figure
plot(t_vec(1000:length(t_vec)), ord_f1(1000:length(t_vec)),'b',...
     t_vec(1000:length(t_vec)), ord_f2(1000:length(t_vec)),'c',...
     t_vec(1000:length(t_vec)), ord_f3(1000:length(t_vec)),'m',...
     t_vec(1000:length(t_vec)), ord_f4(1000:length(t_vec)),'y','LineWidth',2);
y = ylabel('$Thrusts(N)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',15);
set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
ylim([0 12]);
hold on;
% plot(t_vec, 0.9*ones_vec,'--k',...
...
x = xlabel('$Time(sec)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
legend('$f1$','$f2$','$f3$','$f4$', 'Interpreter', 'latex','FontSize',15)
grid on
...
% figure
% subplot(3,1,1)
% plot(t_vec, true_state_vec(1,1:length(t_vec)),'-.r',...
%      t_vec, quadrotor.traj(1,1:length(t_vec)),'c',...
%      t_vec, quadrotor.traj(1,1:length(t_vec)),'--k','LineWidth',2);
% title('Position with and without Efficiency Feedback(EF)','FontSize',20);
% y = ylabel('$x(m)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% legend('$x\ without\ EF$','$x\ with\ EF$','$x\ traj$', 'Interpreter', 'latex','FontSize',20)
% grid on
% subplot(3,1,2)
% plot(t_vec, true_state_vec(2,1:length(t_vec)),'-.r',...
%      t_vec, quadrotor.traj(2,1:length(t_vec)),'c',...
%      t_vec, quadrotor.traj(2,1:length(t_vec)),'--k','LineWidth',2);
% y = ylabel('$y(m)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% legend('$x\ without\ EF$','$x\ with\ EF$','$x\ traj$', 'Interpreter', 'latex','FontSize',20)
% grid on
% subplot(3,1,3)
% plot(t_vec, true_state_vec(3,1:length(t_vec)),'-.r',...
%      t_vec, quadrotor.traj(3,1:length(t_vec)),'c',...
%      t_vec, quadrotor.traj(3,1:length(t_vec)),'--k','LineWidth',2);
% x = xlabel('$Time(sec)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% y = ylabel('$z(m)$', 'rotation', 0, 'Interpreter', 'latex','FontSize',20);
% set(y, 'Units', 'Normalized', 'Position', [-0.09, 0.41]);
% legend('$x\ without\ EF$','$x\ with\ EF$','$x\ traj$', 'Interpreter', 'latex','FontSize',20)
